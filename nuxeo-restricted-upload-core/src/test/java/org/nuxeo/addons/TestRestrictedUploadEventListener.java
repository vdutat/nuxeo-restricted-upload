...
@Deploy({"org.nuxeo.addons.nuxeo-restricted-upload-core"})
public class TestRestrictedUploadEventListener {
    ...
    public void listenerRegistration() {
        EventListenerDescriptor listener = s.getEventListener("restricteduploadeventlistener");
